    ...
    <div className="max-w-4xl space-y-10">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        <section className="bg-zinc-900/40 backdrop-blur-xl border border-white/5 p-6 md:p-8 space-y-8 rounded-2xl shadow-2xl relative overflow-hidden">
          ...
          <div className="space-y-6">
            <div className="space-y-3">
              <label htmlFor="agency_name" className="text-[10px] font-mono text-zinc-500 uppercase tracking-widest block">Nome da Agência</label>
              <input 
                id="agency_name"
            ...
            <div className="space-y-3">
              <label htmlFor="tagline" className="text-[10px] font-mono text-zinc-500 uppercase tracking-widest block">Tagline / Slogan</label>
              <input 
                id="tagline"
                className="w-full bg-black/40 border border-white/10 px-4 py-4 text-white text-sm outline-none focus:border-white/30 transition-all font-mono rounded-xl"
            ...
            <div className="space-y-3">
              <label htmlFor="logo_url" className="text-[10px] font-mono text-zinc-500 uppercase tracking-widest block">URL do Logo</label>
              <input 
                id="logo_url"
        ...
        <section className="bg-zinc-900/40 backdrop-blur-xl border border-white/5 p-6 md:p-8 space-y-8 rounded-2xl shadow-2xl relative overflow-hidden">
          ...
          <div className="space-y-6">
            <div className="space-y-3">
              <label htmlFor="instagram" className="text-[10px] font-mono text-zinc-500 uppercase tracking-widest block">Instagram</label>
            ...
            <div className="space-y-3">
              <label htmlFor="linkedin" className="text-[10px] font-mono text-zinc-500 uppercase tracking-widest block">LinkedIn Profile</label>
              <input 
                id="linkedin"
                className="w-full bg-black/40 border border-white/10 px-4 py-4 text-white text-sm outline-none focus:border-white/30 transition-all font-mono rounded-xl"
            ...
            <div className="space-y-3">
              <label htmlFor="whatsapp" className="text-[10px] font-mono text-zinc-500 uppercase tracking-widest block">WhatsApp Business</label>
              <input 
                id="whatsapp"
                className="w-full bg-black/40 border border-white/10 px-4 py-4 text-white text-sm outline-none focus:border-white/30 transition-all font-mono rounded-xl"
