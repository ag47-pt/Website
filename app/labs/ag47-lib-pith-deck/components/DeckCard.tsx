    ...
    >
      ...
      >
        ...
        >
          ...
          <rect width="100%" height="100%" fill={`url(#pattern-app-${deck.id})`} />
        </svg>
      ...
      <div className="flex-1 flex flex-col justify-between">
        <div>
          <h3 className="font-serif text-xl sm:text-2xl font-normal text-[#f5f2eb] transition-colors duration-300 group-hover:text-[#ff7043] leading-snug">
            {deck.title}
          </h3>
