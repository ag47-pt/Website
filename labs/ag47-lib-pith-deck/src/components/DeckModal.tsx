  ...
  return (
    <AnimatePresence>
      <div className="fixed inset-0 z-50 flex items-center justify-center p-2 sm:p-4 md:p-6">
        ...
        >
          {/* Top Bar with Editorial Metadata & Close Button */}
          ...
          <div className="flex-1 overflow-y-auto p-5 sm:p-8 space-y-8 scrollbar-thin">
            {/* Header / Pitch Deck Title & Punchline */}
            <div>
              ...
              <h2 className="font-editorial-title text-3xl sm:text-4xl lg:text-5xl font-normal text-[#f5f2eb] leading-tight">
                {deck.title}
              </h2>
            ...
            {/* Slide Viewer Interactive Presentation Component */}
            <div>
            ...
            {/* Two-Column Deep Context: Long Description & Project Metrics */}
            <div className="grid grid-cols-1 gap-8 lg:grid-cols-12">
              {/* Left Column: Thesis & Deep Description */}
              <div className="lg:col-span-8 space-y-6">
                <div>
                  <h3 className="font-editorial-title text-xl text-[#f5f2eb] border-b border-[rgba(245,242,235,0.08)] pb-2 mb-3">
                ...
                {deck.metrics && deck.metrics.length > 0 && (
                  <div>
                    <h3 className="font-editorial-title text-lg text-[#f5f2eb] mb-3">
                ...
                {/* Slides Agenda Overview */}
                <div>
                  <h3 className="font-editorial-title text-lg text-[#f5f2eb] border-b border-[rgba(245,242,235,0.08)] pb-2 mb-3">
                    Sumário dos Slides
                  </h3>
              ...
              {/* Right Column: Author, Tags, Actions */}
          ...
          {/* Modal Footer: Navigation between Decks */}
