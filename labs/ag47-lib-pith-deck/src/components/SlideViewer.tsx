...
import { DeckSlide, PitchDeck } from "@/types/deck";
  ...
  return (
    <div className="flex flex-col overflow-hidden border border-[rgba(245,242,235,0.1)] bg-[#0d0f14]">
      ...
      <div className="relative min-h-[300px] sm:min-h-[360px] p-6 sm:p-8 flex flex-col justify-between bg-gradient-to-br from-[#12151c] via-[#0e1017] to-[#090a0d] overflow-hidden">
        ...
        <div className="absolute inset-0 bg-editorial-grain opacity-40 pointer-events-none" />
        ...
        <AnimatePresence mode="wait">
          ...
          >
            ...
            <h4 className="font-editorial-title text-2xl sm:text-3xl font-normal text-[#f5f2eb] leading-tight max-w-2xl">
              {currentSlide.title}
            </h4>
        ...
        {/* Slide Progress Dots & Thumbnails */}
