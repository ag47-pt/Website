...
import { ArrowDown, Flame, FileText, Compass, Sparkles } from "lucide-react";
...
export function HeroSection({
  ...
  return (
    <section className="relative overflow-hidden border-b border-[rgba(245,242,235,0.08)] bg-gradient-to-b from-[#090a0d] via-[#0d0f15] to-[#090a0d] py-16 sm:py-24 lg:py-28">
      {/* Background Architectural Grid & Radial Glow (Warm Terracotta / Subtle Amber, Zero Purple) */}
      ...
      {/* Atmospheric Abstract Layers (Simulating physical pitch deck sheets in space) */}
        ...
        <div className="grid grid-cols-1 gap-12 lg:grid-cols-12 lg:items-center">
          ...
          <div className="lg:col-span-8">
            ...
            <motion.h1
              ...
              className="font-editorial-title text-4xl font-normal tracking-tight text-[#f5f2eb] sm:text-6xl lg:text-7xl leading-[1.08]"
            >
              Ideias que merecem{" "}
              <span className="font-editorial-italic text-[#ff5722] underline decoration-[rgba(255,87,34,0.35)] underline-offset-8">
                virar realidade.
              </span>
            </motion.h1>
            ...
            >
              ...
              <button
                ...
                className="group relative flex items-center gap-2.5 overflow-hidden border border-[#ff5722] bg-[#ff5722] px-6 py-3.5 text-sm font-semibold text-white shadow-[0_0_24px_rgba(255,87,34,0.25)] transition-all duration-300 hover:bg-[#ff7043] hover:shadow-[0_0_32px_rgba(255,87,34,0.4)]"
              >
          ...
          {/* Right Column / Curatorial Feature Widget */}
