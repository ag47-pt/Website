      ...
      <div className="h-screen w-full relative overflow-hidden bg-black">
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center gap-12">
          ...
          <div className="text-center text-white px-4 pointer-events-none select-none">
            <div className="text-4xl md:text-6xl font-black mb-4 tracking-tighter bg-gradient-to-b from-white to-white/40 bg-clip-text text-transparent uppercase opacity-90">
              Agência 47
            </div>
